(function (currentScript) { window.dispatchEvent(new CustomEvent('songbook.ready', { detail: { data: // Added line
{
  ...
  "copyright": "Copyright 1978 by the 福音自传会 Christian Nationals Evangelism Commission, Southeast Asia Headquarter",
  "sections": {
    "Front Cover": {
      "title": {
        "cn": "封面"
  ...
  "songs": {
    "Doxology": {
      ...
      "notes": [
        "Same song: TSMS258a, RHC-doxology",
    ...
    "The Lord Is In His Holy Temple": {
      ...
      "notes": [
        "Same song: RHC-the-lord-is-in-his-holy-temple"
      ]
    },
    "Gloria Patri (Greatorex)": {
      "title": {
      ...
      "notes": [
        "Same song: RHC-gloria-patri-greatorex",
        "Same lyrics: HP-gloria-patri-meineke (English only)"
      ]
    },
    "Gloria Patri (Meineke)": {
      "title": {
      ...
      "notes": [
        "Same song: RHC-gloria-patri-meineke",
        "Same lyrics: HP-gloria-patri-greatorex (English only)"
      ]
    },
    "1": {
      "title": {
    ...
    "7": {
      ...
      "notes": [
        "Same song: RHC003 (1 stanza more)",
    ...
    "21": {
      ...
      "music": {
        "composers": [
          "Melody from Ninth Symphony, Ludwig Van Beethoven"
        ],
        "tune": "THE FATHER",
        "keySignature": [
          "G"
      ...
      "lyrics": {
        ...
        "en": {
          ...
          "2": [
            "All Thy works with joy surround Thee, Earth and heav'n reflect Your rays,",
          ...
          "3": [
            ...
            "Thou the Father, Christ our Brother - All hwo live in love are Thine:",
    ...
    "32": {
      ...
      "notes": [
        "Same song: RHC058 (stanza 4 different in Chinese)"
      ]
    },
    "33": {
      "title": {
    ...
    "38": {
      ...
      "notes": [
        "Same song: RHC073 (stanzas 2 & 3 different for Chinese lyrics)",
    ...
    "53": {
      ...
      "notes": [
        "Same song: RHC053 (1 stanza more)",
        "Same lyrics: RHC052"
      ]
    },
    "55": {
      ...
      "notes": [
        "Same song: RHC057 (1 stanza more)",
        "Same tune: RHC231"
      ]
    },
    "57": {
    ...
    "59": {
      "title": {
        "en": "When Morning Gilds the Skies",
        "cn": "晨光灿烂耀空"
      },
      "music": {
        "composers": [
    ...
    "60": {
      ...
      "notes": [
        "Same song: RHC010 (1 stanza more)"
      ]
    },
    "61": {
      "title": {
    ...
    "146": {
      ...
      "notes": [
        "Same song: TSMS310, EHS002 (chorus only), RHC087 (1 stanza more)"
      ]
    },
    "149": {
      "title": {
    ...
    "152": {
      ...
      "notes": [
        "Same song: TSMS450 (1 stanza more, 1 stanza diff), RHC297 (1 stanza more, 1 stanza diff)"
      ]
    },
    "178": {
      "title": {
    ...
    "186": {
      ...
      "notes": [
        "Same song: RHC200 (1 stanza more)",
        "Same tune: RHC234"
      ]
    },
    "210": {
    ...
    "The Lord Bless You And Keep You": {
      ...
      "notes": [
        "Same song: RHC-the-lord-bless-you-and-keep-you"
      ]
    },
    "Twofold Amen": {
      "title": {
    ...
    "May The Grace Of Christ Our Savior": {
      ...
      "notes": [
        "Same song: RHC-may-the-grace-of-christ-our-savior-stanza1only"
      ]
    }
  }
}

...
(function () { window.dispatchEvent(new CustomEvent('songbook.ready', { detail: { data: 
{
  ...
  "songs": {
      ...
      "lyrics": {
        ...
        "en": {
          ...
          "2": [
            ...
            "In our home of bliss and glory, We shall sing forevermore!"
          ],
          "chorus": [
            "Glory in the highest heaven! Sound aloud the joyful strain,",
            "Glory to the Lamb be given, Who for sinners once was slain."
          ]
        },
        "cn": {
          "1": [
    ...
    "197": {
      ...
      "lyrics": {
        "authors": [
          "Theodulph of Orleans, trans. by John M. Neale"
        ]
      },
      "notes": [
